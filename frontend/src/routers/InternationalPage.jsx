  ...
  <>
    ...
    <Switch>
      ...
      <Route
        path="/questionnaire"
        exact
        component={() => <QuestionnairePage setUserAuthorized={setUserAuthorized} entity={entity} />}
      />
      <Route
        path="/login"
        exact
      ...
      <Route
        path="/register"
        exact
        component={() => <RegisterPage setUserAuthorized={setUserAuthorized} entity={entity} />}
      />
      <Route
        path="/documents"
        exact
        component={() => <DocumentVerificationPage setUserAuthorized={setUserAuthorized} entity={entity} />}
      />
      <Route
        path="/dashboard"
